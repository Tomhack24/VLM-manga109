...
from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import (F, Any, Callable, Optional, Union, torch, nn, ACT2FN, GenerationMixin, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, can_return_tuple, Qwen2_5_VLTextConfig, Qwen2_5_VLVisionConfig, logger, __name__, Qwen2_5_VLPreTrainedModel, Qwen2_5_VLModel, KwargsForCausalLM, Qwen2_5_VLCausalLMOutputWithPast, Qwen2_5_VLForConditionalGeneration)
    ...
    **kwargs: Unpack[KwargsForCausalLM],
    ...
    if RETURN_HIDDEN_STATES:
        ...
        if () not in (None, (),):
            ...
            logits = logits * ()
        loss = self.loss_function(logits=logits, labels=labels.to(self.lm_head.weight.device), self.config.vocab_size)
